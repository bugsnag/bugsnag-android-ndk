...
extern "C" {
  ...
  JNIEXPORT void JNICALL Java_com_bugsnag_android_ndk_test_MainActivity_causeCppBus (JNIEnv *env, jobject instance);
...
JNIEXPORT void JNICALL
Java_com_bugsnag_android_ndk_test_MainActivity_causeCppBus(JNIEnv *env, jobject instance) {
